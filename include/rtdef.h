...
#define RTGRAPHIC_CTRL_LIGHTER          6
#define RTGRAPHIC_CTRL_DARKER         	7
#define RTGRAPHIC_CTRL_BACKON       		8
#define RTGRAPHIC_CTRL_BACKOFF       		9
...
{
    void (*set_pixel) (rt_uint16_t color, int x, int y);
    void (*get_pixel) (rt_uint16_t color, int x, int y);

    void (*draw_hline)(rt_uint16_t color, int x1, int x2, int y);
    void (*draw_vline)(rt_uint16_t color, int x, int y1, int y2);

    void (*blit_line) (rt_uint16_t color, int x, int y, rt_size_t size);
	
		void (*fillfull_screen)(rt_uint16_t color);
	
		void (*fill_fb)(rt_uint16_t color, int start_x, int end_x,int start_y, int end_y);
		
		void (*set_bmp)(rt_uint16_t x,rt_uint16_t y,void* bmp,rt_uint16_t bmp_width,rt_uint16_t bmp_hight);
	
		void (*set_font24)(rt_uint16_t x,rt_uint16_t y,void *ptr,rt_uint16_t fontcolor,rt_uint16_t backcolor);
	
		void (*draw_circle)(rt_uint16_t color, int x, int y, int r);
	
		void (*draw_line)(rt_uint16_t color, int x1, int y1,int x2, int y2);
	
//		void (*touch_driver)(void);
};
