...
static const struct stm_baud_rate_tab can_baud_rate_tab[] =
{
    ...
    {CAN125kBaud, (CAN_SJW_1TQ | CAN_BS1_5TQ  | CAN_BS2_1TQ | 48)},
...
void HAL_CAN_MspInit(CAN_HandleTypeDef* canHandle)
{
	...
	__HAL_CAN_ENABLE_IT(canHandle, CAN_IER_FMPIE0);
	__HAL_CAN_ENABLE_IT(canHandle, CAN_IER_FFIE0);
	__HAL_CAN_ENABLE_IT(canHandle, CAN_IER_FOVIE0);
	__HAL_CAN_ENABLE_IT(canHandle, CAN_IER_FMPIE1);
	__HAL_CAN_ENABLE_IT(canHandle, CAN_IER_FFIE1);
	__HAL_CAN_ENABLE_IT(canHandle, CAN_IER_FOVIE1);
		
	__HAL_CAN_ENABLE_IT(canHandle, CAN_IER_BOFIE);
	__HAL_CAN_ENABLE_IT(canHandle, CAN_IER_LECIE);
	__HAL_CAN_ENABLE_IT(canHandle, CAN_IER_ERRIE);
