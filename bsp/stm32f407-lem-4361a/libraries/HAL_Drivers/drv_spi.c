...
static rt_uint32_t spixfer(struct rt_spi_device *device, struct rt_spi_message *message)
{
    ...
    rt_size_t message_length, already_send_length,take_lenth;
...
//    if (message->cs_take)
		...
		take_lenth = message->length;
	
		if ((message->cs_take)&&(take_lenth == 0))//wyg190902
    {
...
//    if (message->cs_release)
		if ((message->cs_release)&&(take_lenth == 0))//wyg190902
    {
